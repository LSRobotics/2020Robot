...
public class PixyCam {
    ...
    */
     ...
     * 
     * Integer goodBlocks = 0; int counter = 0; Block biggest = new Block(0, 0, 0,
     * 0, 0, 0, 0, 0);
     * 
     ...
     * 
     * for(Block block : blockBuffer) { counter ++;
     * 
     * if(counter == 1) { biggest = block; } else { if(block.getWidth() >
     * biggest.getWidth()) { biggest = block; } } }
     * 
     * return biggest; }
     */
